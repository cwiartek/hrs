...
public class JPACriteriaEmployeeFinder implements EmployeeFinder {
    ...
    public EmployeeSearchResult search(EmployeeSearchCriteria criteria) {
        ...
        cq.select(cb.construct(BasicEmployeeDto.class,
                employee.get(Employee_.empNo), employee.get(Employee_.firstName), employee.get(Employee_.lastName)));
        ...
        EmployeeSearchResult employeeSearchResults = new EmployeeSearchResult();
