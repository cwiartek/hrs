...
public class EmployeeTest {
    private final Address address = new Address("Polnocna", "Lublin");
    ...
    @Test
    public void shouldAllowMultipleChangesSalary() {
    ...
    @Test
    public void shouldReturnEmptyDepartmentWhenNoAssigment() {
    ...
    @Test
    public void shouldAssignDepartments() {
