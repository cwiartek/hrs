...
public class EmployeeFinderTest extends InfrastructureTest {
    ...
    public void np1Demo() {
        ...
        executeTransaction((entityManager) ->  {
            List<Employee> emps = entityManager.createQuery("SELECT e FROM Employee e JOIN FETCH e.salaries JOIN FETCH e.address").
                    getResultList();
            for(Employee e :emps) {
    ...
    private Employee createEmployee(String firstName, String lastName, String birthDate) {
        ...
        executeTransaction((em) -> em.persist(employee));
        return employee;
    }
